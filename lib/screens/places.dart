...
import 'package:favorite_places/providers/favorite_places.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        ConnectionState.waiting ? const Center(child: CircularProgressIndicator()) : PlacesList(places: favoritePlaces),
      ),
      ),
    );
  }
